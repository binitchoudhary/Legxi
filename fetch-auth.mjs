...
const r = await fetch(`${BASE}?asset[key]=sections/certificate-authentication.liquid`, { headers: H });
const d = await r.json();
if (!d.asset) { console.log('ERR:', JSON.stringify(d)); process.exit(1); }
writeFileSync('theme/sections/certificate-authentication.liquid', d.asset.value, 'utf8');
